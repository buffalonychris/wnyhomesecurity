...
| QRLanding Runtime | `/docs/runtime/qrlanding_runtime.md` | PARTIAL | QR placard attribution + QR funnel runtime behavior | `/docs/system/step-current.md`, `/docs/runtime/request_id_contract.md`, `/docs/runtime/lead_signal_contract.md` | RUNTIME008 | REV01 created with QR attribution assumptions, requestId lifecycle expectations, and Cloudflare KPI interpretation guidance; promote to ACTIVE after operator verification of live analytics and attribution ops. |
...
- RUNTIME008 — QR Attribution + Funnel Analytics Runtime Documentation
