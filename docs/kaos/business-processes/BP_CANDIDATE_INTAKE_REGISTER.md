...
- **Notes:** Full artifact contents were imported as source artifacts only by KAOS-BP005A. Candidate source-package naming is controlled by `candidate-artifacts/bp001-source-package/MANIFEST.md`; prior BP001 register labels were preliminary labels until reconciled by KAOS-BP005B. Individual process candidates require operator review before approval or promotion.
...
Artifact names, source file names, review order, and package naming follow `candidate-artifacts/bp001-source-package/MANIFEST.md`. Prior BP001 labels in earlier register entries were preliminary labels and do not supersede MANIFEST-controlled source-package naming.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WNYHS-BP001A | WNYHS Business Process Discovery Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001A_Business_Process_Discovery_Sweep.md` | Business process discovery / KAOS candidate intake | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; depends on operator review before any promotion. |
| WNYHS-BP001B | Quote, Install, Payment, Scheduling, and Support Deep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001B_Revenue_Operations_Deep_Sweep.md` | Revenue operations / install lifecycle / support lifecycle | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; prior preliminary label no longer controls source-package naming. |
| WNYHS-BP001C | HubSpot, Stripe, Scheduling, and Revenue Records Deep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001C_Revenue_Records_Deep_Sweep.md` | Revenue records / payment state / scheduling state / admin lifecycle | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; any future review must preserve HubSpot REV03, Stripe, scheduling, and protected runtime boundaries. |
| WNYHS-BP001D | BOM, Hardware Qualification, Inventory, Vendor, and Installer Packet Deep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001D_BOM_Hardware_Inventory_Deep_Sweep.md` | BOM / hardware qualification / inventory readiness / vendor / installer packet | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; earlier BOM-related preliminary label no longer controls source-package naming. |
| WNYHS-BP001E | Customer Handoff, Dashboard Training, Warranty, Support, and Add-On Lifecycle Deep Sweep | Pilot reviewed / Revision requested | Operator Revision Requested | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001E_Handoff_Warranty_Support_Deep_Sweep.md` | Customer handoff / dashboard training / warranty / support / add-on lifecycle | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B. KAOS-BP004 BOM Parts Qualification review remains historical lineage from the earlier preliminary label mapping; it did not approve a process and did not create an Active KAOS Rule. |
| WNYHS-BP001F | Website Funnel, Fit Check, Planner, Route Governance, SEO, and Claims-Control Deep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001F_Website_Funnel_SEO_Claims_Deep_Sweep.md` | Website funnel / Fit Check / planner / route governance / SEO / claims control | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; any future review must preserve route, SEO, claims, and funnel guardrails. |
| WNYHS-BP001G | Governance, Codex, Repository, Runtime Contracts, QA, Hooks, and RSI Deep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001G_Governance_Codex_QA_Hooks_RSI_Deep_Sweep.md` | Governance / Codex / repository / runtime contracts / QA / hooks / RSI | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; no QA checks, hooks, automations, or runtime enforcement are created by this register entry. |
| WNYHS-BP001H | Cross-Vertical BKAS / Reliable Elder Care / HALO Reconciliation Prep Sweep | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001H_Cross_Vertical_Reconciliation_Prep.md` | Cross-vertical reconciliation prep / BKAS / Reliable Elder Care / HALO | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; prior preliminary label no longer controls source-package naming. |
| WNYHS-BP001I | Candidate Process Reconciliation | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001I_Candidate_Process_Reconciliation.md` | BP001 candidate process reconciliation | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; prior preliminary label no longer controls source-package naming. |
| WNYHS-BP001J | Business Capability Mapping | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001J_Business_Capability_Mapping.md` | Business capability mapping / process-to-capability mapping | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; prior preliminary label no longer controls source-package naming. |
| WNYHS-BP001K | BPR001 Candidate Register Generation | Candidate / Pending Operator Review | Candidate | Repo-hosted candidate source artifact: `candidate-artifacts/bp001-source-package/WNYHS-BP001K_BPR001_Candidate_Register_Generation.md` | BPR001 candidate register generation / master candidate business process register | Not repository authority; no active KAOS authority | Yes | Not approved | Source-package naming reconciled to `MANIFEST.md` by KAOS-BP005B; no hooks, automations, runtime enforcement, or active register authority are created by this entry. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BP001-PACKAGE | WNYHS BP001A-BP001K Candidate Package | Project Governance / KAOS | Business process discovery | Candidate package intake | Candidate | `docs/kaos/business-processes/candidate-artifacts/bp001-source-package/` | Repo-hosted source package imported by KAOS-BP005A; contents are candidate-only and not repository authority; source-package naming controlled by `MANIFEST.md` after KAOS-BP005B reconciliation | Candidate Package Received / Pending Review | Operator review required | Pending | Not approved | REV01 intake placeholder | None | None | Initial candidate package source artifacts imported for future review citation | Not retired | Unknown until individual process review | None approved | Candidate only; no hook spec created | Candidate only; no SOP created | Source package row only; no individual process rule is approved. Prior BP001 labels were preliminary labels and no longer control source-package naming. |
| BOM-PARTS-QUALIFICATION-CANDIDATE | BOM Parts Qualification | Catalog / Package / Hardware | Internal hardware and BOM evidence control | Determine whether hardware or part candidates have enough evidence for later BOM, catalog, package, quote, installer, or customer-language planning | Operator Revision Requested | Historical KAOS-BP004 pilot lineage from preliminary BP001E label mapping; current BP001E source-package name is `WNYHS-BP001E_Handoff_Warranty_Support_Deep_Sweep.md` per `MANIFEST.md` | Exact candidate source content was missing during KAOS-BP004; review used repo authority and then-current candidate-register metadata only | Pilot reviewed / Revision requested | Owner missing | Revision requested | Not approved | REV01 candidate interpretation | None | None | KAOS-BP004 first pilot review created candidate interpretation and recorded evidence gaps before KAOS-BP005B source-package naming reconciliation | Not retired | Catalog, quote, CRM, payment, scheduling, runtime, public-claim, dependency boundaries checked; no changes authorized | None approved | Candidate only; no hook spec created | Candidate only; no SOP created | Review record: `BP_REVIEW_KAOS_BP004_BOM_PARTS_QUALIFICATION_REV01.md`; preserved as historical lineage only; Active KAOS Rule created: No; activation task not created. |
