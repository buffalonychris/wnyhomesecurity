...
### VISPARITY011
- **Task ID:** VISPARITY011
- **Task Name:** Packages Visual Adoption
- **Status:** DONE
- **Category:** QA / VISUAL / IMPLEMENTATION
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Apply the approved VISPARITY008 semantic token/base visual system to package-related public page visual surfaces without changing package copy, pricing/package wording, routes, production images, form behavior, or protected systems.
- **Allowed Scope:** Package route/component visual selectors; package-specific CSS/style selectors; shared package/tier component styling where required for package visual adoption; visible site version badge; visual-parity README implementation reference; this Master Task Register record.
- **Forbidden Scope:** No HubSpot files/config, Stripe/payment files/config, scheduling files/config, Resend/email files/config, runtime/API files, Cloudflare config, dependencies, package-lock, public image assets, generated visual boards/thumbnails, package copy/content, headings, CTA wording, pricing/package wording, route definitions, form payloads, submit behavior, tracking/runtime behavior, image generation, image replacement, non-package page redesign, homepage content, solution/category page content, PR merge, or ready-for-review PR marking.
- **Target Files:** `src/index.css`; `src/styles/homeSecurityPremium.css`; `src/lib/siteVersion.ts`; `docs/design-system/visual-parity/README.md`; `docs/system/master-task-register.md`.
- **Runtime Systems Affected:** None. Package page CSS/token adoption only.
- **Documentation Updates Required:** Add this VISPARITY011 tracking record because it was missing from the Master Task Register and the bounded prompt explicitly authorized adding a record; update the visual-parity README narrow implementation reference.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted semantic-token `rg` against changed source/style files; raw hex audit against changed source/style files with any remaining values explained; protected-system/package-pricing diff audit for HubSpot/Stripe/scheduling/runtime/payment/submit/payload/api/price/pricing terms; merge-marker scan in docs/src/public; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git status --short`; verify changed files are limited to package/style/docs/version files.
- **Exit Criteria:** Package landing/detail visual selectors, package tier cards, comparison/context blocks, included-feature/list surfaces, price/status note surfaces, CTA/button styling, proof/value blocks, spacing/rhythm, borders/radii/shadows, hover/focus states, and text hierarchy consume VISPARITY008 semantic variables; no dark/black default page background is introduced; package copy, headings, CTA wording, pricing/package wording, links/destinations, routes, production images, form payloads, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, non-package content, homepage content, solution/category content, generated boards/thumbnails, and public image assets remain untouched; visible site version is bumped to `v1.0.182`; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded VISPARITY011 work order; latest `main`; merged PR #443 / VISPARITY010; VISPARITY008; VISPARITY009; VISPARITY010; DESIGN003; DESIGN004; VISUALFREEZE002; DESIGN002; PAGE_TOKEN_COMPLIANCE_GATE; package standard; brand asset standards; page layout standards; header/footer standards; public funnel standards; QR funnel standards; current governance authority chain; `docs/codex/CODEX_RUN_CONTRACT.md`; OPS004; OPS005.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task is `VISPARITY012 - Lead Generation / Funnel Visual Adoption`.
- **Completion Notes:** Applied VISPARITY008 semantic token styling to package-related public visual surfaces by updating package landing/context panels, package tier/card surfaces, package media/caption treatment, package price/status notes, package detail hero/list/card surfaces, package CTA hover/focus states, package final CTA treatment, and comparison/package context card surfaces in `src/index.css` and `src/styles/homeSecurityPremium.css`; bumped the visible site version to `v1.0.182`; updated the visual-parity README with a narrow VISPARITY011 implementation reference. Package copy, headings, CTA wording, pricing/package wording, links/destinations, routes, production images, public assets, form payloads, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, generated boards/thumbnails, non-package page content, homepage content, and solution/category page content were not changed.

### VISPARITY012
- **Task ID:** VISPARITY012
- **Task Name:** Lead Generation / Funnel Visual Adoption
- **Status:** DONE
- **Category:** QA / VISUAL / IMPLEMENTATION
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Apply the approved VISPARITY008 semantic token/base visual system to lead-generation and funnel-related public visual surfaces without changing lead/funnel copy, routes, form behavior, payloads, production images, or protected systems.
- **Allowed Scope:** Lead-generation/funnel route visual selectors; funnel-specific CSS/style selectors; shared funnel form/card/panel/step component styling where required for funnel visual adoption; visible site version badge; visual-parity README implementation reference; this Master Task Register record.
- **Forbidden Scope:** No HubSpot files/config, Stripe/payment files/config or payment logic, scheduling files/config or scheduling logic, Resend/email files/config, runtime/API files, Cloudflare config, dependencies, package-lock, public image assets, generated visual boards/thumbnails, homepage content, package page content, solution/category page content, route definitions, form payloads, submit behavior, validation logic, form fields, CTA wording, tracking/runtime behavior, image generation, image replacement, non-funnel redesign, PR merge, or ready-for-review PR marking.
- **Target Files:** `src/styles/canonicalEstimateForm.css`; `src/styles/wnyhsVisualGovernance.css`; `src/styles/homeSecurityPremium.css`; `src/index.css`; `src/lib/siteVersion.ts`; `docs/design-system/visual-parity/README.md`; `docs/system/master-task-register.md`.
- **Runtime Systems Affected:** None. Lead-generation/funnel CSS/token adoption only.
- **Documentation Updates Required:** Add this VISPARITY012 tracking record because it was missing from the Master Task Register and the bounded prompt explicitly authorized adding a record; update the visual-parity README narrow implementation reference.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted semantic-token `rg` against changed source/style files; raw hex audit against changed source/style files with any remaining values explained; protected-system/funnel-behavior diff audit for HubSpot/Stripe/scheduling/runtime/payment/submit/payload/api/validation/field/form terms; merge-marker scan in docs/src/public; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`; verify changed files are limited to funnel/style/docs/version files.
- **Exit Criteria:** Contact/estimate form shells, Fit Check surfaces, funnel cards/panels, helper/error/status surfaces, CTA/button styling, schedule/contact panels, success/cancel/status pages, step rail, spacing/rhythm, borders/radii/shadows, hover/focus states, and text hierarchy consume VISPARITY008 semantic variables; no dark/black default page background is introduced; lead/funnel copy, CTA wording, links/destinations, routes, production images, form fields, form payloads, validation logic, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, non-funnel content, generated boards/thumbnails, and public image assets remain untouched; visible site version is bumped to `v1.0.183`; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded VISPARITY012 work order; latest `main`; merged VISPARITY011 work; VISPARITY008; VISPARITY009; VISPARITY010; VISPARITY011; DESIGN003; DESIGN004; VISUALFREEZE002; DESIGN002; PAGE_TOKEN_COMPLIANCE_GATE; brand asset standards; page layout standards; header/footer standards; public funnel standards; current governance authority chain; `docs/codex/CODEX_RUN_CONTRACT.md`; OPS004; OPS005.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task is `VISPARITY013 - Solutions / Category Visual Adoption`.
- **Completion Notes:** Applied VISPARITY008 semantic token styling to lead-generation and funnel-related public visual surfaces by updating contact/estimate form shells, Fit Check surfaces, funnel cards/panels, helper/error/status surfaces, CTA/button states, shared funnel step rail styling, and quote/agreement/payment/schedule funnel card/form/status selectors in CSS only. Bumped the visible site version to `v1.0.183`; updated the visual-parity README with a narrow VISPARITY012 implementation reference. Lead/funnel copy, headings, CTA wording, links/destinations, routes, production images, public assets, form fields, form payloads, validation logic, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling logic, Resend/email, Cloudflare config, dependencies, package-lock, generated boards/thumbnails, homepage content, package content, solution content, and category content were not changed.

### VISPARITY013
- **Task ID:** VISPARITY013
- **Task Name:** Solutions / Category Visual Adoption
- **Status:** DONE
- **Category:** QA / VISUAL / IMPLEMENTATION
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Apply the approved VISPARITY008 semantic token/base visual system to solution and category-related public visual surfaces without changing solution/category copy, routes, CTA wording, production images, image paths, runtime behavior, or protected systems.
- **Allowed Scope:** Solution/category route visual selectors; solution/category-specific CSS/style selectors; shared solution/category card, tile, Vault, Core, proof, scenario, and image-role container styling where required for visual adoption; visible site version badge; visual-parity README implementation reference; this Master Task Register record.
- **Forbidden Scope:** No HubSpot files/config, Stripe/payment files/config or payment logic, scheduling files/config or scheduling logic, Resend/email files/config, runtime/API files, Cloudflare config, dependencies, package-lock, public image assets, generated visual boards/thumbnails, homepage content, package page content, lead/funnel page content, route definitions, form payloads, submit behavior, validation logic, form fields, CTA wording, tracking/runtime behavior, image generation, image replacement, solution/category copy, solution/category headings, solution/category routes, non-solution/category redesign, PR merge, or ready-for-review PR marking.
- **Target Files:** `src/index.css`; `src/styles/homeSecurityPremium.css`; `src/styles/wnyhsVisualGovernance.css`; `src/lib/siteVersion.ts`; `docs/design-system/visual-parity/README.md`; `docs/system/master-task-register.md`.
- **Runtime Systems Affected:** None. Solution/category CSS/token adoption only.
- **Documentation Updates Required:** Add this VISPARITY013 tracking record because it was missing from the Master Task Register and the bounded prompt explicitly authorized adding a record; update the visual-parity README narrow implementation reference.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted semantic-token `rg` against changed source/style files; raw hex audit against changed source/style files with any remaining values explained; protected-system/route/image/form diff audit for HubSpot/Stripe/scheduling/runtime/payment/submit/payload/api/validation/field/form/image/asset/route terms; merge-marker scan in docs/src/public; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`; verify changed files are limited to solution/category/style/docs/version files.
- **Exit Criteria:** Solution landing/listing visual selectors, solution detail hero/proof/scenario/detail surfaces, category landing hero/media/proof/card/specialty sections, category solution cards, Vault tiles, Core panels, CTA/button styling, proof/value blocks, spacing/rhythm, borders/radii/shadows, hover/focus states, image-role containers, and text hierarchy consume VISPARITY008 semantic variables; no dark/black default page background is introduced; solution/category copy, headings, CTA wording, links/destinations, routes, production images, image filenames/paths, public image assets, form payloads, submit behavior, validation logic, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, homepage content, package content, lead/funnel content, generated boards/thumbnails, and public image assets remain untouched; visible site version is bumped to `v1.0.184`; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded VISPARITY013 work order; latest `main`; merged VISPARITY012 work; VISPARITY008; VISPARITY009; VISPARITY010; VISPARITY011; VISPARITY012; DESIGN003; DESIGN004; VISUALFREEZE002; DESIGN002; PAGE_TOKEN_COMPLIANCE_GATE; CATEGORY003; brand asset standards; page layout standards; header/footer standards; public funnel standards; current governance authority chain; `docs/codex/CODEX_RUN_CONTRACT.md`; OPS004; OPS005.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task is `VISPARITY014 - Remaining Public Pages Visual Adoption`.
- **Completion Notes:** Applied VISPARITY008 semantic token styling to solution/category-related public visual surfaces by updating solution listing cards and image frames, solution detail hero/proof/scenario/feature surfaces, category hero/Core/media/solution-card focus surfaces, Vault tile and Core panel token usage, and solution/category hover/focus states in existing CSS selectors. Bumped the visible site version to `v1.0.184`; updated the visual-parity README with a narrow VISPARITY013 implementation reference. Solution/category copy, headings, CTA wording, links/destinations, routes, production images, image filenames/paths, public assets, form fields, form payloads, validation logic, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling logic, Resend/email, Cloudflare config, dependencies, package-lock, generated boards/thumbnails, homepage content, package content, and lead/funnel content were not changed.

### VISPARITY014
- **Task ID:** VISPARITY014
- **Task Name:** Remaining Public Pages Visual Adoption
- **Status:** DONE
- **Category:** QA / VISUAL / IMPLEMENTATION
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Apply the approved VISPARITY008 semantic token/base visual system to remaining public-facing page visual surfaces not already covered by VISPARITY009 through VISPARITY013 without changing page copy, routes, CTA wording, production images, public assets, form behavior, runtime behavior, or protected systems.
- **Allowed Scope:** Remaining public page route/component visual class adoption; remaining public page CSS/style selectors; shared remaining public-page visual primitives where required; QR campaign visual selectors; visible site version badge; visual-parity README implementation reference; this Master Task Register record.
- **Forbidden Scope:** No HubSpot files/config, Stripe/payment files/config or payment logic, scheduling files/config or scheduling logic, Resend/email files/config, runtime/API files, Cloudflare config, dependencies, package-lock, public image assets, generated visual boards/thumbnails, homepage content, package page content, lead/funnel page content, solution/category page content, route definitions, form payloads, submit behavior, validation logic, form fields, CTA wording, tracking/runtime behavior, image generation, image replacement, page copy, headings, links/destinations, non-public redesign, PR merge, or ready-for-review PR marking.
- **Target Files:** `src/pages/FAQ.tsx`; `src/pages/Funding.tsx`; `src/styles/qrLanding.css`; `src/styles/wnyhsVisualGovernance.css`; `src/lib/siteVersion.ts`; `docs/design-system/visual-parity/README.md`; `docs/system/master-task-register.md`.
- **Runtime Systems Affected:** None. Remaining public page CSS/token adoption and class-level visual adoption only.
- **Documentation Updates Required:** Add this VISPARITY014 tracking record because it was missing from the Master Task Register and the bounded prompt explicitly authorized adding a record; update the visual-parity README narrow implementation reference.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted semantic-token `rg` against changed source/style files; raw hex audit against changed source/style files with any remaining values explained; protected-system/route/image/form diff audit for HubSpot/Stripe/scheduling/runtime/payment/submit/payload/api/validation/field/form/image/asset/route/copy/heading/CTA terms; merge-marker scan in docs/src/public; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`; verify changed files are limited to remaining-public-page/style/docs/version files.
- **Exit Criteria:** Remaining public informational and QR campaign surfaces consume VISPARITY008 semantic variables for page canvas, surfaces, cards, informational blocks, CTA/button styling, spacing/rhythm, borders/radii/shadows, hover/focus states, and text hierarchy; no dark/black default page background is introduced; page copy, headings, CTA wording, links/destinations, routes, production images, image filenames/paths, public assets, form fields, form payloads, validation logic, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, homepage content, package content, lead/funnel content, solution/category content, and generated boards/thumbnails remain untouched; visible site version is bumped to `v1.0.185`; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded VISPARITY014 work order; latest `main`; completed VISPARITY013 work; VISPARITY008; VISPARITY009; VISPARITY010; VISPARITY011; VISPARITY012; DESIGN003; DESIGN004; VISUALFREEZE002; DESIGN002; PAGE_TOKEN_COMPLIANCE_GATE; brand asset standards; page layout standards; header/footer standards; public funnel standards; QR funnel standards; current governance authority chain; `docs/codex/CODEX_RUN_CONTRACT.md`; OPS004; OPS005.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task is `VISPARITY015 - Public Route Sweep / Visual QA`.
- **Completion Notes:** Applied VISPARITY008 semantic token styling to remaining public informational and QR campaign visual surfaces by converting FAQ and Funding wrappers/cards away from generic dark surfaces and inline raw hex styles, adding shared remaining info-page primitives, and converting QR landing canvas, panels, topbar, proof chips, form controls, benefit cards, next-step cards, focus states, and status colors to WNYHS semantic variables. Bumped the visible site version to `v1.0.185`; updated the visual-parity README with a narrow VISPARITY014 implementation reference. Page copy, headings, CTA wording, links/destinations, routes, production images, image filenames/paths, public assets, form fields, form payloads, validation logic, submit behavior, tracking/runtime behavior, runtime/API files, HubSpot, Stripe/payment, scheduling logic, Resend/email, Cloudflare config, dependencies, package-lock, generated boards/thumbnails, homepage content, package content, lead/funnel content, and solution/category content were not changed.

### VISPARITY015
- **Task ID:** VISPARITY015
- **Task Name:** Public Route Sweep / Visual QA
- **Status:** DONE
- **Category:** QA / VISUAL / AUDIT
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Verify that public-facing WNYHS routes are visually accounted for after VISPARITY009 through VISPARITY014 and document route-by-route visual coverage, review posture, and follow-up needs.
- **Allowed Scope:** Route/source audit; public route coverage record; visual/token QA findings; visual-parity README audit reference; this Master Task Register record; minimal public-page style fixes only if a clearly missed token issue can be safely corrected without changing copy, routes, assets, forms, payloads, validation, submit behavior, runtime behavior, or protected systems.
- **Forbidden Scope:** No HubSpot files/config, Stripe/payment files/config or payment logic, scheduling files/config or scheduling logic, Resend/email files/config, runtime/API files, Cloudflare config, dependencies, package-lock, public image assets, generated visual boards/thumbnails, page copy/content, headings, CTA wording, links/destinations, production images, route definitions, form payloads, submit behavior, validation logic, image generation, image replacement, broad redesign, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/design-system/visual-parity/VISPARITY015_PUBLIC_ROUTE_VISUAL_QA_REV01.md`; `docs/design-system/visual-parity/README.md`; `docs/system/master-task-register.md`; minimal public-page style files only if a safe corrective visual-token issue is found; `src/lib/siteVersion.ts` only if source/style changes require a visible version bump.
- **Runtime Systems Affected:** None. Documentation-only public route visual coverage audit.
- **Documentation Updates Required:** Add this VISPARITY015 tracking record because it was missing from the Master Task Register and the bounded prompt explicitly authorized adding a record; create the VISPARITY015 public route visual QA record; update the visual-parity README narrow audit reference.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for VISPARITY015, Public Route Visual QA, Follow-up required, Needs follow-up, and VISPARITY009 through VISPARITY014; if source/style files changed, semantic-token and raw-hex audits against changed source/style files; protected-system/copy/route/form/image diff audit; merge-marker scan in docs/src/public; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`; relevant existing Playwright visual/smoke route check when feasible without adding dependencies.
- **Exit Criteria:** Route discovery sources are documented; public, review, and non-public route families are classified; each current public-facing WNYHS route family has a visual coverage source task or a follow-up classification; no page copy, CTA wording, links, routes, image paths, production assets, forms, payloads, validation, submit behavior, runtime behavior, protected systems, Cloudflare config, dependencies, or package-lock files are changed; visible version bump is omitted unless source/style changes are made; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded VISPARITY015 work order; latest `main`; completed VISPARITY014 work; VISPARITY008; VISPARITY009; VISPARITY010; VISPARITY011; VISPARITY012; VISPARITY013; DESIGN003; DESIGN004; VISUALFREEZE002; DESIGN002; PAGE_TOKEN_COMPLIANCE_GATE; brand asset standards; page layout standards; header/footer standards; public funnel standards; QR funnel standards; SEO route inventory and SEO004 status handoff; current governance authority chain; `docs/codex/CODEX_RUN_CONTRACT.md`; OPS004; OPS005.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task is `OPS009 - Codex Workflow + RSI Governance Update`.
- **Completion Notes:** Created the docs-only VISPARITY015 public route visual QA record. The audit classifies homepage, canonical categories, legacy flat category aliases, route-backed solutions, packages, Fit Check/contact/support/search/about/our-work/legal, FAQ/funding/comparison/reliability, QR campaign, transaction, planner, dashboard/demo, legacy, adjacent, vendor, business, operator, and test route families by public/review/non-public posture and VISPARITY009 through VISPARITY014 visual coverage source. No small safe corrective visual-token issue was applied; remaining raw color/dark-surface findings were documented as follow-up because they involve legacy/review/adjacent routes, protected transaction/payment/scheduling/quote/agreement surfaces, print routes, Precision Planner, static demos, or approved token definitions. No source/style/version files, page copy, headings, CTA wording, links/destinations, routes, production images, public assets, forms, payloads, validation logic, submit behavior, runtime/API files, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, generated boards/thumbnails, or public assets were changed.

### OPS009
- **Task ID:** OPS009
- **Task Name:** Codex Workflow + RSI Governance Update
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Formalize Codex workflow, operator/ChatGPT/Codex responsibilities, PR review posture, lightweight prerequisite verification, targeted-read policy, missing-task handling, Windows Codex hook usage, RSI/context efficiency reporting, token/context usage categories, and semantic-token/theme-readiness reporting after the DESIGN / VISUALFREEZE / VISPARITY009-VISPARITY015 execution series.
- **Allowed Scope:** Docs/governance only; create `docs/system/OPS009_CODEX_WORKFLOW_AND_RSI_GOVERNANCE_REV01.md`; narrowly update `docs/codex/CODEX_RUN_CONTRACT.md`; update this Master Task Register record; update catalog/manifest references required for the new governance doc.
- **Forbidden Scope:** No source, runtime, routes, pages, components, styles, CSS, tokens, public copy, public assets, generated images, payment, scheduling, HubSpot, Resend/email, Cloudflare config, dependencies, package-lock, THEME implementation, INSTALL implementation, hooks, automation, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/system/OPS009_CODEX_WORKFLOW_AND_RSI_GOVERNANCE_REV01.md`; `docs/codex/CODEX_RUN_CONTRACT.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only governance update.
- **Documentation Updates Required:** Create OPS009 workflow/RSI governance; narrowly update the Codex run contract to distinguish current full-read defaults from future targeted-read allowance; add this bounded MTR tracking record; add catalog/manifest references for the new governance doc.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `OPS009`, `Codex Workflow`, `RSI`, `Context Efficiency`, `token usage`, `Operator handoff`, `lightweight prerequisite`, `targeted MTR`, `Windows Codex hooks`, `semantic token`, `theme-readiness`, `INSTALL001`, and `THEME001` in `docs/system`, `docs/codex`, and `AGENTS.md`; merge-marker scan in `docs`; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`; verify changed files are limited to docs/governance files and catalog/register references.
- **Exit Criteria:** OPS009 governance doc exists and covers working model, operator/ChatGPT/Codex responsibilities, GitHub/Codex assumptions, Windows Codex hooks, lightweight prerequisite verification, targeted-read policy, missing-task handling, RSI/context-efficiency reporting, token/context usage categories, semantic-token/theme-readiness reporting, and future INSTALL/THEME planning notes; no source/runtime/style/page copy/protected-system files are changed; validation passes; draft PR is opened without merge.
- **Dependencies:** Prompt-created bounded OPS009 work order; restart clarification requiring current `CODEX_RUN_CONTRACT.md` full-read behavior for this run; completed VISPARITY015; current governance authority chain; OPS003; OPS004; OPS005.
...
### INSTALL003
- **Task ID:** INSTALL003
- **Task Name:** Golden Home Assistant Build Standard
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Golden Home Assistant Build Standard defining the reusable baseline controller state for Home Assistant-based installs before customer-specific customization.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; add this bounded Master Task Register record because INSTALL003 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboards, automations, scripts, customer-specific install docs, funeral-home-specific configuration, hardware purchasing, inventory automation, ordering automation, HubSpot changes, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only Golden Build standard.
- **Documentation Updates Required:** Create INSTALL003 standard; add bounded task-register record because INSTALL003 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL003`, `Golden Home Assistant`, `Golden Build`, `baseline controller`, `customer-specific`, `backup readiness`, `restore validation`, `theme-ready`, `INSTALL004`, `INSTALL005`, `INSTALL006`, `INSTALL007`, and `INSTALL008` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Golden Home Assistant Build Standard REV01 exists and covers purpose, what the Golden Build is and is not, required baseline categories, Golden versus customer-specific boundary, bench build relationship, backup/restore expectations, theme readiness, funeral home pilot relevance, future INSTALL004/005/006/007/008 planning notes, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL003` work order; INSTALL002 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL004 - Device Naming Standard`.
- **Completion Notes:** Created the initial docs-only WNYHS Golden Home Assistant Build Standard for repeatable Home Assistant baseline controller preparation before customer-specific customization. Defined the Golden Build as a reusable baseline, not a customer configuration, one-customer backup, final dashboard package, or automation library. Documented required baseline categories, Golden versus customer-specific boundaries, bench checklist relationship, backup/restore expectations, theme-readiness posture, funeral home pilot relevance, future INSTALL004/005/006/007/008 planning notes, and protected-system exclusions. No source, routes, UI, styles, public assets, Home Assistant config, dashboards, automations, scripts, customer-specific install docs, funeral-home-specific configuration, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL004
- **Task ID:** INSTALL004
- **Task Name:** Device Naming Standard
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Device Naming Standard for Home Assistant-based installs so physical devices have clear, stable, supportable identities during bench build and field installation.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; add this bounded Master Task Register record because INSTALL004 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboards, automations, scripts, customer-specific install docs, device inventory data, entity naming standard, area standard, funeral-home-specific configuration, hardware purchasing, inventory automation, ordering automation, HubSpot changes, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only physical device naming standard.
- **Documentation Updates Required:** Create INSTALL004 standard; add bounded task-register record because INSTALL004 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL004`, `Device Naming Standard`, `Device naming sheet`, `Front Door Contact Sensor`, `Basement Utility Leak Sensor`, `Customer-visible`, `provisional`, `onsite confirmation`, `INSTALL005`, `INSTALL006`, and `INSTALL008` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Device Naming Standard REV01 exists and covers purpose, physical-device naming scope, naming principles, recommended naming pattern, internal versus customer-visible names, bench naming workflow, physical labeling, device naming sheet fields, at least 20 example device names, anti-patterns, relationship to INSTALL002/003/005/006, funeral home pilot relevance, future INSTALL005/006/008 planning notes, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL004` work order; INSTALL003 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL005 - Entity and Area Standards`.
- **Completion Notes:** Created the initial docs-only WNYHS Device Naming Standard for Home Assistant-based installs. Defined physical-device naming scope, plain-language naming principles, the `[Area / Room] [Function / Location] [Device Type]` recommended pattern, internal versus customer-visible naming, provisional bench names, onsite confirmation, bench naming workflow, physical labeling expectations, device naming sheet fields, 26 example device names across security, safety, lighting/control, cameras, utility, and infrastructure, anti-patterns, relationship to INSTALL002/003/005/006, funeral home pilot relevance, future INSTALL005/006/008 planning notes, and protected-system exclusions. No source, routes, UI, styles, public assets, Home Assistant config, dashboards, automations, scripts, customer-specific install docs, device inventory data, funeral-home-specific configuration, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL005
- **Task ID:** INSTALL005
- **Task Name:** Entity and Area Standards
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Entity and Area Standards for Home Assistant-based installs so areas, rooms, zones, device-to-area placement, and entities remain readable, supportable, dashboard-ready, and automation-ready after physical device naming is established.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`; add this bounded Master Task Register record because INSTALL005 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboards, automations, scripts, customer-specific install docs, actual customer entity/device/area data, funeral-home-specific configuration, hardware purchasing, inventory automation, ordering automation, HubSpot changes, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only entity and area standard.
- **Documentation Updates Required:** Create INSTALL005 standard; add bounded task-register record because INSTALL005 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL005`, `Entity and Area Standards`, `Area Name`, `Entity Display Name`, `Visibility Class`, `Customer-visible`, `Automation-ready`, `Dashboard-ready`, `Front Door Contact Sensor Contact`, `Basement Utility Leak Sensor Moisture`, `INSTALL006`, `INSTALL007`, `INSTALL008`, and `INSTALL010` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Entity and Area Standards REV01 exists and covers purpose, scope, area/room principles, recommended area types, area naming pattern, device-to-area assignment rules, entity naming principles, entity naming pattern, cleanup workflow, visibility classes, disabled/duplicate/noisy entity handling, review sheet fields, at least 20 examples across required device categories, anti-patterns, relationship to INSTALL002/003/004/006/008, funeral home pilot relevance, future INSTALL006/007/008/010 planning notes, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL005` work order; INSTALL004 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL006 - Dashboard Architecture Standard`.
- **Completion Notes:** Created the initial docs-only WNYHS Entity and Area Standards for Home Assistant-based installs. Defined area/room principles, recommended area types, the `[Plain Area / Room Name]` area naming pattern, device-to-area assignment rules, the `[Device Name] [Capability]` entity naming pattern, entity cleanup workflow, visibility classes, disabled/duplicate/noisy entity handling, area and entity review sheet fields, 22 example rows across contacts, motion, leak, cameras, doorbells, plugs/switches, locks, repeaters/radios, and utility/environment sensors, anti-patterns, relationship to INSTALL002/003/004/006/008, funeral home pilot relevance, future INSTALL006/007/008/010 planning notes, and protected-system exclusions. No source, routes, UI, styles, public assets, Home Assistant config, dashboards, automations, scripts, customer-specific install docs, customer-specific area/device/entity data, funeral-home-specific configuration, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL006
- **Task ID:** INSTALL006
- **Task Name:** Dashboard Architecture Standard
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Dashboard Architecture Standard for Home Assistant-based installs so Customer, Installer, and Service dashboard classes remain consistent, supportable, theme-ready, and aligned with the installer platform.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; add this bounded Master Task Register record because INSTALL006 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific dashboards, customer-specific install files, actual customer dashboard data, funeral-home-specific configuration, hardware purchasing, inventory automation, ordering automation, HubSpot changes, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only dashboard architecture standard.
- **Documentation Updates Required:** Create INSTALL006 standard; add bounded task-register record because INSTALL006 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL006`, `Dashboard Architecture Standard`, `Customer Dashboard`, `Installer Dashboard`, `Service Dashboard`, `Dashboard Readiness Sheet`, `Theme-ready`, `Offline Devices`, `Low Batteries`, `INSTALL007`, `INSTALL008`, `INSTALL009`, and `INSTALL010` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Dashboard Architecture Standard REV01 exists and covers purpose, scope, Customer/Installer/Service dashboard classes, recommended customer/installer/service views, status hierarchy, customer personalization placeholders, card grouping principles, navigation, mobile/tablet usability, access/visibility posture, theme readiness, Dashboard Readiness Sheet fields, at least 20 examples across required categories, anti-patterns, relationship to INSTALL002-INSTALL010, funeral home pilot relevance, future INSTALL007-INSTALL010 planning notes, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL006` work order; INSTALL005 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL006A - Shared Job Data Model & HubSpot Field Architecture`.
- **Completion Notes:** Created the initial docs-only WNYHS Dashboard Architecture Standard for Home Assistant-based installs. Defined Customer, Installer, and Service Dashboard classes; recommended customer, installer, and service view groups; status hierarchy; customer personalization placeholders; card grouping and navigation principles; mobile/tablet usability; access and visibility posture; theme-readiness posture; Dashboard Readiness Sheet fields; 28 examples across customer, installer, service, security, cameras, locks, lighting, leak/water, utilities, diagnostics, and support; anti-patterns; relationship to INSTALL002-INSTALL010; funeral home pilot relevance; future INSTALL007/008/009/010 planning notes; and protected-system exclusions. No source, routes, UI, styles, public assets, Home Assistant config, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific dashboards, customer-specific install files, actual customer dashboard data, funeral-home-specific configuration, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL006A
- **Task ID:** INSTALL006A
- **Task Name:** Shared Job Data Model & HubSpot Field Architecture
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS shared job data model architecture connecting upstream sales/SOW/quote/BOM/order/inventory workflows to downstream bench build, install, dashboard, signoff, warranty, support, HubSpot, and future installer portal workflows.
- **Allowed Scope:** Docs/data-architecture only; create `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`; add this bounded Master Task Register record because INSTALL006A was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, database changes, APIs, scripts, HubSpot field creation, HubSpot object creation, HubSpot schema/property/pipeline/workflow changes, direct HubSpot writes, portal implementation, runtime sync, Home Assistant configuration implementation, dashboards, automations, customer-specific install files, actual customer data, hardware purchasing, inventory automation, ordering automation, Stripe/payment sync, scheduling sync, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL/HUBSPOT/PORTAL/INVENTORY/ASSET/WARRANTY tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only shared job data model and candidate HubSpot field architecture.
- **Documentation Updates Required:** Create INSTALL006A architecture document; add bounded task-register record because INSTALL006A was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL006A`, `Shared Job Data Model`, `HubSpot Field Architecture`, `Contact / Customer`, `Property`, `Estimate`, `SOW`, `Quote`, `BOM`, `Bench Build`, `Installed Asset`, `Warranty`, `Support Ticket`, `Portal Visibility`, `HUBSPOT-INSTALL001`, and `PORTAL001` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Shared Job Data Model and HubSpot Field Architecture REV01 exists and covers purpose, source boundary, shared record chain, upstream model, downstream INSTALL model, candidate HubSpot object/record architecture, candidate property groups, candidate field inventory, portal screen architecture, business process stages, protected-system boundaries, open questions, future task roadmap, and recommended next task; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL006A` work order; INSTALL006 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`; `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL007 - Dashboard Theme Readiness Standard`.
- **Completion Notes:** Created the initial docs-only WNYHS Shared Job Data Model and HubSpot Field Architecture. Defined the candidate shared record chain from Contact / Customer through Expansion / Add-on Opportunity; upstream sales/estimate/SOW/quote/BOM/order/inventory posture; downstream INSTALL001-INSTALL006 mapping; candidate HubSpot object/record architecture; candidate property groups; candidate field inventory; private installer/admin portal screen planning; business process stages; protected-system boundaries; open questions; and planning-only future tasks. No source, routes, UI, styles, public assets, runtime code, APIs, scripts, database changes, Home Assistant config, dashboards, automations, customer-specific install files, actual customer data, HubSpot schema/properties/objects/workflows, direct HubSpot writes, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL007
- **Task ID:** INSTALL007
- **Task Name:** Dashboard Theme Readiness Standard
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Dashboard Theme Readiness Standard for Home Assistant-based installs so future Customer, Installer, and Service dashboards remain ready for light, dark, high-contrast, seasonal, and customer-selected themes without dashboard rewrites.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL007_DASHBOARD_THEME_READINESS_STANDARD_REV01.md`; add this bounded Master Task Register record because INSTALL007 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, Home Assistant theme files, theme YAML, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific dashboards, customer-specific install files, actual customer dashboard data, funeral-home-specific configuration, funeral-home-specific themes, hardware purchasing, inventory automation, ordering automation, HubSpot changes, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL/THEME tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL007_DASHBOARD_THEME_READINESS_STANDARD_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only dashboard theme-readiness standard.
- **Documentation Updates Required:** Create INSTALL007 standard; add bounded task-register record because INSTALL007 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL007`, `Dashboard Theme Readiness Standard`, `Default Light`, `Default Dark`, `High Contrast`, `Theme Readiness Review Sheet`, `color-only`, `theme-ready`, `THEME001`, `THEME002`, `THEME003`, `INSTALL008`, `INSTALL009`, and `INSTALL010` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Dashboard Theme Readiness Standard REV01 exists and covers purpose, scope, theme readiness principles, future theme classes, Customer/Installer/Service Dashboard requirements, conceptual semantic role categories, accessibility/status rules, card and view design rules, Theme Readiness Review Sheet fields, at least 20 examples across required dashboard classes and categories, anti-patterns, relationship to other INSTALL docs, relationship to public website token work, funeral home pilot relevance, future INSTALL008/009/010 and THEME001/002/003 planning notes, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL007` work order; INSTALL006A merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL008 - Bench Testing and Commissioning Checklist`.
- **Completion Notes:** Created the initial docs-only WNYHS Dashboard Theme Readiness Standard for Home Assistant-based installs. Defined theme-readiness principles; future planning-only theme classes; Customer, Installer, and Service Dashboard theme-readiness expectations; conceptual semantic role categories; accessibility and status rules; card and view design rules; Theme Readiness Review Sheet fields; 28 examples across customer, installer, service, security, cameras, lighting, leak/water, locks, utility, offline devices, low batteries, failed automations, and support notes; anti-patterns; relationship to INSTALL003/006/008/009/010; relationship to public website VISPARITY semantic-token thinking; funeral home pilot relevance; future THEME001/002/003 planning notes; and protected-system exclusions. No source, routes, UI, styles, public assets, runtime code, Home Assistant config, Home Assistant theme files, dashboard YAML, Lovelace cards, frontend assets, automations, scripts, customer-specific dashboards, customer-specific install files, actual customer dashboard data, funeral-home-specific configuration, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL008
- **Task ID:** INSTALL008
- **Task Name:** Bench Testing and Commissioning Checklist
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Bench Testing and Commissioning Checklist for validating Home Assistant-based systems during bench testing and onsite commissioning before customer handoff.
- **Allowed Scope:** Docs/checklist only; create `docs/installer/INSTALL008_BENCH_TESTING_AND_COMMISSIONING_CHECKLIST_REV01.md`; add this bounded Master Task Register record because INSTALL008 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboard YAML, Lovelace cards, themes, automations, scripts, customer-specific install docs, actual customer records, customer data, HubSpot fields, HubSpot schema/object/pipeline/workflow changes, APIs, portal screens, durable storage, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL/HUBSPOT/PORTAL/ASSET/WARRANTY tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL008_BENCH_TESTING_AND_COMMISSIONING_CHECKLIST_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only bench testing and commissioning checklist.
- **Documentation Updates Required:** Create INSTALL008 checklist; add bounded task-register record because INSTALL008 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL008`, `Bench Testing and Commissioning Checklist`, `Evidence / proof`, `Commissioning Status`, `Critical Blockers`, `Exception ID`, `Bench Build`, `Install Job`, `Commissioning Record`, `Customer Signoff`, `Installed Asset Register`, `Warranty Record`, `Support Ticket`, `INSTALL009`, and `INSTALL010` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Bench Testing and Commissioning Checklist REV01 exists and covers purpose, scope, checklist fields, bench testing sections, onsite commissioning sections, evidence/proof standards, commissioning status categories, critical blockers, exception handling fields, shared data model relationship, funeral home pilot relevance, future task references, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL008` work order; INSTALL007 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`; `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL007_DASHBOARD_THEME_READINESS_STANDARD_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL009 - Customer Handoff Package`.
- **Completion Notes:** Created the initial docs-only WNYHS Bench Testing and Commissioning Checklist for Home Assistant-based installs. Defined bench validation, onsite commissioning, checklist fields, bench testing sections, onsite commissioning sections, evidence/proof standards, commissioning status categories, critical blockers, exception handling fields, shared data model relationship, funeral home pilot relevance, future task references, and protected-system exclusions. No source, routes, UI, styles, public assets, runtime code, Home Assistant config, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific install docs, actual customer records, customer data, funeral-home-specific records, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL009
- **Task ID:** INSTALL009
- **Task Name:** Customer Handoff Package
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Customer Handoff Package standard for Home Assistant-based installs so customer-safe post-install handoff content is bounded before templates, PDFs, portals, records, or runtime implementation.
- **Allowed Scope:** Docs/package-standard only; create `docs/installer/INSTALL009_CUSTOMER_HANDOFF_PACKAGE_REV01.md`; add this bounded Master Task Register record because INSTALL009 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboard YAML, Lovelace cards, themes, automations, scripts, customer-specific handoff documents, customer records, PDFs, emails, Home Assistant configs, dashboards, actual customer data, HubSpot fields, HubSpot schema/object/pipeline/workflow changes, APIs, portal implementation, durable storage, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future INSTALL/HUBSPOT/PORTAL/ASSET/WARRANTY/CUSTOMERDOC tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL009_CUSTOMER_HANDOFF_PACKAGE_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only customer handoff package standard.
- **Documentation Updates Required:** Create INSTALL009 standard; add bounded task-register record because INSTALL009 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL009`, `Customer Handoff Package`, `Installed Asset Summary`, `Customer Training Confirmation`, `Customer Signoff`, `Warranty Record`, `Support Ticket`, `Future add-on`, `no alarm monitoring claims`, `no dispatch claims`, `INSTALL010`, and `CUSTOMERDOC001` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Customer Handoff Package REV01 exists and covers purpose, scope, required handoff package sections, customer-safe language rules, dashboard orientation, installed asset summary concept and fields, warranty/support section, customer training confirmation, signoff fields, relationship to INSTALL006A shared data model, relationship to INSTALL002/006/006A/008/009/010, funeral home pilot relevance, future task references, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL009` work order; INSTALL008 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL002_BENCH_BUILD_CHECKLIST_REV01.md`; `docs/installer/INSTALL003_GOLDEN_HOME_ASSISTANT_BUILD_STANDARD_REV01.md`; `docs/installer/INSTALL004_DEVICE_NAMING_STANDARD_REV01.md`; `docs/installer/INSTALL005_ENTITY_AND_AREA_STANDARDS_REV01.md`; `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL007_DASHBOARD_THEME_READINESS_STANDARD_REV01.md`; `docs/installer/INSTALL008_BENCH_TESTING_AND_COMMISSIONING_CHECKLIST_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `INSTALL010 - Service Dashboard and Remote Support Standard`.
- **Completion Notes:** Created the initial docs-only WNYHS Customer Handoff Package standard for Home Assistant-based installs. Defined customer-safe system summary posture, required handoff sections, customer-safe language rules, dashboard orientation rules, installed asset summary fields, warranty/support basics, customer training confirmation, customer signoff fields, shared data model relationship, relationship to existing INSTALL docs, funeral home pilot relevance, future task references, and protected-system exclusions. No source, routes, UI, styles, public assets, runtime code, Home Assistant config, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific handoff docs, actual customer records, customer data, funeral-home-specific records, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, or future task activations were changed.

### INSTALL010
- **Task ID:** INSTALL010
- **Task Name:** Service Dashboard and Remote Support Standard
- **Status:** DONE
- **Category:** GOV
- **Controlling Context:** CTX-WNYHS-FINAL-HOUR-BUSDEV-REV01
- **Purpose:** Create the initial WNYHS Service Dashboard and Remote Support Standard for Home Assistant-based installs so post-handoff internal service visibility, remote support posture, support-safe diagnostics, warranty/support handoff, and protected boundaries are defined before any dashboard, remote access, HubSpot, portal, support-ticket, or runtime implementation.
- **Allowed Scope:** Docs/standard only; create `docs/installer/INSTALL010_SERVICE_DASHBOARD_AND_REMOTE_SUPPORT_STANDARD_REV01.md`; add this bounded Master Task Register record because INSTALL010 was missing; update `docs/DOCUMENT_CATALOG.md`; update `docs/MARKDOWN_MANIFEST.md` if required by repo registration pattern.
- **Forbidden Scope:** No source, routes, UI, styles, public assets, runtime code, Home Assistant configuration implementation, dashboard YAML, Lovelace cards, themes, automations, scripts, customer-specific dashboards, customer records, actual customer data, remote access credentials, private URLs, HubSpot fields, HubSpot schema/object/pipeline/workflow changes, APIs, portal implementation, support ticket records, warranty records, asset records, PDFs, emails, durable storage, Stripe/payment changes, scheduling changes, Resend/email changes, Cloudflare config, environment files/secrets, dependencies, package-lock, public claims, task activation for future HUBSPOT-INSTALL/PORTAL/ASSET/WARRANTY/SUPPORT/THEME tasks, PR merge, or ready-for-review PR marking.
- **Target Files:** `docs/installer/INSTALL010_SERVICE_DASHBOARD_AND_REMOTE_SUPPORT_STANDARD_REV01.md`; `docs/system/master-task-register.md`; `docs/DOCUMENT_CATALOG.md`; `docs/MARKDOWN_MANIFEST.md`.
- **Runtime Systems Affected:** None. Documentation-only service dashboard and remote support standard.
- **Documentation Updates Required:** Create INSTALL010 standard; add bounded task-register record because INSTALL010 was missing; register the document in catalog and manifest addendum.
- **Validation Required:** `git diff --check`; `git diff --cached --check` if staged; targeted `rg` for `INSTALL010`, `Service Dashboard and Remote Support Standard`, `Remote support authorized`, `Offline Devices`, `Low Batteries`, `Failed Automations`, `Installed Assets`, `Warranty / Support`, `no alarm monitoring claims`, `no dispatch claims`, `no emergency response claims`, `HUBSPOT-INSTALL001`, `PORTAL001`, `ASSET001`, `WARRANTY001`, and `SUPPORT001` in docs; merge-marker scan in docs; `npx tsc -p tsconfig.app.json --noEmit`; `cmd /c npm run build`; `git ls-files --deleted`; `git status --short`.
- **Exit Criteria:** Service Dashboard and Remote Support Standard REV01 exists and covers purpose, scope, Service Dashboard purpose, recommended service dashboard views, remote support posture, support-safe diagnostic categories, support status categories, warranty/support handoff, Service Dashboard Readiness Sheet fields, Remote Support Authorization fields, privacy/claim guardrails, relationship to INSTALL006/006A/007/008/009/010, funeral home pilot relevance, future task references, and protected-system boundaries; only allowed documentation files changed; protected systems untouched; validation passes; draft PR opened without merge.
- **Dependencies:** Prompt-created bounded `INSTALL010` work order; INSTALL009 merged and current `main` synced; CODEX run contract; OPS009 workflow; current governance authority chain; `docs/system/step-current.md`; targeted Master Task Register review; `docs/installer/INSTALL001_INSTALLER_PLATFORM_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL006_DASHBOARD_ARCHITECTURE_STANDARD_REV01.md`; `docs/installer/INSTALL006A_SHARED_JOB_DATA_MODEL_AND_HUBSPOT_FIELD_ARCHITECTURE_REV01.md`; `docs/installer/INSTALL007_DASHBOARD_THEME_READINESS_STANDARD_REV01.md`; `docs/installer/INSTALL008_BENCH_TESTING_AND_COMMISSIONING_CHECKLIST_REV01.md`; `docs/installer/INSTALL009_CUSTOMER_HANDOFF_PACKAGE_REV01.md`.
- **Operator Decision Required:** Review draft PR and decide whether to merge. Recommended next task after merge: `HUBSPOT-INSTALL001 - HubSpot Installer Property/Object Model Spec`.
- **Completion Notes:** Created the initial docs-only WNYHS Service Dashboard and Remote Support Standard for Home Assistant-based installs. Defined post-handoff Service Dashboard purpose, recommended service dashboard views, conditional remote support posture, support-safe diagnostic categories, support status categories, warranty/support handoff relationships, Service Dashboard Readiness Sheet fields, Remote Support Authorization fields, privacy/claim guardrails, relationship to existing INSTALL docs, funeral home pilot relevance, future task references, and protected-system exclusions. No source, routes, UI, styles, public assets, runtime code, Home Assistant config, dashboard YAML, Lovelace cards, frontend assets, themes, automations, scripts, customer-specific service dashboards, actual customer records, customer data, funeral-home-specific records, remote access credentials, HubSpot, Stripe/payment, scheduling, Resend/email, Cloudflare config, dependencies, package-lock, environment, secrets, support tickets, warranty records, asset records, portal files, or future task activations were changed.
