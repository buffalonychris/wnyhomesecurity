...
| C09 | North Wall Window 5 | Sonoff SenseGuard Gen 2 Contact Sensor | North Wall |  |  |  |
...
| C12 | South Wall Window 3 | Sonoff SenseGuard Gen 2 Contact Sensor | South Wall |  |  |  |
| C13 | South Wall Window 4 | Sonoff SenseGuard Gen 2 Contact Sensor | South Wall |  |  |  |
| C14 | South Wall Window 5 | Sonoff SenseGuard Gen 2 Contact Sensor | South Wall |  |  |  |
...
- [ ] Mount all C01-C14 contact sensors.
- [ ] Confirm each contact sensor opens/closes correctly after mounting.
- [ ] Confirm each contact sensor magnet aligns correctly.
