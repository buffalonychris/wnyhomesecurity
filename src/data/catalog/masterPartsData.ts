...
// CATALOG004 imports the first reviewed master-parts backfill from
// docs/catalog/imports/catalog004/. Keep these records internal until a future
// bounded task explicitly maps them into solutions, packages, or quote flows.
