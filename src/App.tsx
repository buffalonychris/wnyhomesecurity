...
const GovernanceViewer = lazy(() => import('./pages/GovernanceViewer'));
...
const BetaSolutions = lazy(() => import('./beta/BetaSolutions'));
...
const BetaLighting = lazy(() => import('./beta/BetaLighting'));
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route element={<DefaultLayout />}>
            ...
            <Route path="/solutions/vacation-homes" element={<SolutionOpportunity />} />
          ...
          <Route element={<OperatorLayout />}>
            ...
            <Route path="/operator/governance" element={<GovernanceViewer />} />
